...
Generated: 2026-04-10 13:57 UTC
...
- **New composite correlation**: r=0.1466 (p=0.0)
- **New composite Q1 (lowest scores)**: 30.5% WR, -18.14% avg return
- **New composite Q5 (highest scores)**: 51.1% WR, 9.97% avg return
- **Quintile spread**: 28.11 pp
- **Top 10% by new score**: 48.1% WR, 6.59% avg return
- **Bottom 10% by new score**: 31.8% WR, -15.0% avg return
...
### Premium Leverage (Weight: 65.0%)

Importance: 0.5516, Subscores: 2

| Subscore | Feature | Weight | r | Cohen's d | Direction | Monotonic | Tier |
|----------|---------|--------|---|-----------|-----------|-----------|------|
| Entry Delta | `entry_delta` | 77.0% | -0.2015 | -0.4247 | lower_is_better | none | tier1 |
| Entry IV | `entry_iv` | 23.0% | -0.0559 | -0.1269 | lower_is_better | none | tier1 |
...
**Entry IV breakpoints:**

| Value | Score | Quintile WR | Quintile Avg Return |
|-------|-------|-------------|---------------------|
| 0.1362 | 100 | 40.9% | -3.29% |
| 0.3026 | 80 | 46.0% | 4.91% |
| 0.3665 | 60 | 46.1% | 3.31% |
| 0.4554 | 40 | 41.0% | -3.44% |
| 1.0217 | 20 | 33.8% | -12.54% |

### Move Feasibility (Weight: 25.0%)

Importance: 0.2000, Subscores: 2

| Subscore | Feature | Weight | r | Cohen's d | Direction | Monotonic | Tier |
|----------|---------|--------|---|-----------|-----------|-----------|------|
| Time-Adj Feasibility | `fvt_time_adjusted_feasibility` | 50.0% | 0.0452 | 0.0972 | higher_is_better | none | tier2 |
| FVT Feasibility Ratio | `fvt_feasibility_ratio` | 50.0% | 0.0404 | 0.1028 | higher_is_better | none | tier2 |

**Time-Adj Feasibility breakpoints:**

| Value | Score | Quintile WR | Quintile Avg Return |
|-------|-------|-------------|---------------------|
| 0.0000 | 20 | 31.2% | -15.02% |
| 0.0000 | 40 | 40.2% | -3.85% |
| 0.1605 | 60 | 50.1% | 7.68% |
| 0.4506 | 80 | 43.5% | -2.02% |
| 0.9153 | 100 | 43.6% | 2.15% |

**FVT Feasibility Ratio breakpoints:**
...
| 0.2071 | 60 | 49.9% | 8.33% |
| 0.5254 | 80 | 44.1% | -1.08% |
| 1.2524 | 100 | 43.3% | 0.56% |

### Setup Quality (Weight: 10.0%)

Importance: 0.0501, Subscores: 2

| Subscore | Feature | Weight | r | Cohen's d | Direction | Monotonic | Tier |
|----------|---------|--------|---|-----------|-----------|-----------|------|
| Dte Bucket | `dte_bucket` | 60.0% | 0.0000 | 0.0000 | categorical | categorical | tier1 |
| Scanner Convergence | `convergence_count` | 40.0% | 0.0226 | 0.0501 | unclear | none | tier1 |
...
```
composite = 0.65 x Premium Leverage + 0.25 x Move Feasibility + 0.10 x Setup Quality
```
...
|---------|-----------|---|----------------|
| ADX (14) | -0.4087 | -0.2266 | Denormalize onto PaperPosition. ADX measures trend strength direction-agnostically — a strong trend (high ADX) helps both calls and puts that are positioned with the trend. Only n=395 currently due to limited feature history, but it's the strongest structural directional-strength signal available. |
...
| New Premium Leverage | — | 0.2090 | — |
| New Move Feasibility | — | 0.0450 | — |
| New Setup Quality | — | 0.0817 | — |
| **Old Conviction (composite)** | **0.0029** | — | — |
| **New Composite** | — | **0.1466** | **+0.1437** |

### New Composite Quintile Performance

| Quintile | Range | n | Win Rate | Avg Return | Median Return |
|----------|-------|---|----------|------------|---------------|
| Q1 | 20.0 — 38.3 | 3101 | 30.5% | -18.14% | -53.66% |
| Q2 | 38.3 — 52.3 | 3101 | 33.2% | -14.28% | -53.49% |
| Q3 | 52.3 — 63.0 | 3101 | 42.8% | 0.80% | -51.08% |
| Q4 | 63.0 — 74.4 | 3101 | 51.1% | 10.57% | 12.46% |
| Q5 | 74.5 — 100.0 | 3101 | 51.1% | 9.97% | 50.00% |

### Premium Leverage Quintile Performance

| Quintile | Range | n | Win Rate | Avg Return |
|----------|-------|---|----------|------------|
| Q1 | 21.7 — 40.0 | 2366 | 33.6% | -14.61% |
| Q2 | 40.0 — 49.5 | 2366 | 30.7% | -18.43% |
| Q3 | 49.5 — 68.9 | 2366 | 33.6% | -13.04% |
| Q4 | 68.9 — 80.8 | 2366 | 51.9% | 14.37% |
| Q5 | 80.8 — 100.0 | 2370 | 57.9% | 20.61% |

### Move Feasibility Quintile Performance

| Quintile | Range | n | Win Rate | Avg Return |
|----------|-------|---|----------|------------|
| Q1 | 20.0 — 20.0 | 3101 | 31.2% | -15.02% |
| Q2 | 20.0 — 20.0 | 3101 | 40.2% | -3.85% |
| Q3 | 20.0 — 72.7 | 3101 | 49.9% | 7.84% |
| Q4 | 72.7 — 84.3 | 3101 | 42.8% | -2.90% |
| Q5 | 84.3 — 100.0 | 3101 | 44.6% | 2.86% |

### Setup Quality Quintile Performance

| Quintile | Range | n | Win Rate | Avg Return |
|----------|-------|---|----------|------------|
| Q1 | 10.0 — 14.0 | 2366 | 37.3% | -11.30% |
| Q2 | 14.0 — 30.0 | 2366 | 36.8% | -9.89% |
| Q3 | 30.0 — 46.0 | 2366 | 45.1% | 2.27% |
| Q4 | 46.0 — 46.0 | 2366 | 40.9% | -1.58% |
| Q5 | 46.0 — 94.0 | 2370 | 47.6% | 9.42% |

### Top/Bottom Decile Analysis

| Segment | n | Win Rate | Avg Return | Median Return | Avg Composite |
|---------|---|----------|------------|---------------|---------------|
| top_10pct | 1550 | 48.1% | 6.59% | -47.40% | 87.4 |
| bottom_10pct | 1550 | 31.8% | -15.00% | -53.18% | 22.2 |

### Scanner-Specific Comparison

| Scanner | n | Old Conviction r | New Composite r | Improvement |
|---------|---|------------------|-----------------|-------------|
| BREAKDOWN | 219 | -0.3523 | 0.1327 | -0.2197 |
| BREAKOUT | 771 | 0.3199 | -0.0069 | -0.3130 |
| CHEAP_OPTIONS | 6,996 | -0.0162 | 0.1424 | +0.1261 |
| COMPRESSION_EXPANSION | 538 | 0.1508 | 0.2141 | +0.0634 |
| REVALIDATION | 29 | 0.2261 | -0.0624 | -0.1637 |
| UNUSUAL_VOLUME | 6,949 | -0.0158 | 0.1672 | +0.1515 |
