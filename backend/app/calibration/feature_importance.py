...
FEATURE_REGISTRY: list[FeatureRegistryEntry] = [
    ...
    ("entry_spread_pct", "Spread %", None, None, None, False),
    ("entry_open_interest", "Open Interest", None, None, None, True),
    ("entry_volume", "Volume", None, None, None, True),
    ("entry_iv", "Entry IV", "structure", "raw_iv", 0.25, None),
    ("entry_delta", "Entry Delta", "structure", "delta_moneyness", 0.50, None),
    ("dte_at_entry", "DTE at Entry", "structure", "dte_appropriateness", 0.25, True),
