...
async def track_trade(request: TrackTradeRequest) -> dict[str, Any]:
    ...
    snapshot = EvaluationSnapshot(
        ...
        premium_leverage_score=float(decision.get("premium_leverage_score", 0)),
        underlying_behavior_score=float(decision.get("underlying_behavior_score", 0)),
        setup_quality_score=float(decision.get("setup_quality_score", 0)),
