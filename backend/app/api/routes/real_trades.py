...
async def track_trade(request: TrackTradeRequest) -> dict[str, Any]:
    ...
    snapshot = EvaluationSnapshot(
        ...
        directional_score=float(decision.get("directional_score", 0)),
        volatility_score=float(decision.get("volatility_score", 0)),
        structure_score=float(decision.get("structure_score", 0)),
