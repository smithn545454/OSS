...
const defaultConfig: PolicyConfigType = {
  ...
  pillars: {
    ...
    composite_formula: 'weighted_sum' as const,
    premium_leverage: {
      pillar_id: 'PREMIUM_LEVERAGE' as const,
      display_name: 'Premium Leverage',
      description: 'Theta-adjusted edge and premium efficiency',
      numeric_subscores: [],
      categorical_subscores: [],
    },
    underlying_behavior: {
      pillar_id: 'UNDERLYING_BEHAVIOR' as const,
      display_name: 'Underlying Behavior',
      description: 'Volatility regime and underlying momentum',
      numeric_subscores: [],
      categorical_subscores: [],
    },
    setup_quality: {
      pillar_id: 'SETUP_QUALITY' as const,
      display_name: 'Setup Quality',
      description: 'Contract structure and liquidity',
      numeric_subscores: [],
      categorical_subscores: [],
    },
  },
